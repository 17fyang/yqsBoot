...
public class UserControllerImpl implements UserController {
    ...
    @Override
    public @ResponseBody
    String GetInfo() throws LogicException {
        return userService.getInfo().toJSONString();
    }

    @Override
    public @ResponseBody
    String Login(@NecessaryPara String phoneNumber, @NecessaryPara String password) throws LogicException {
        return userService.login(phoneNumber, password).toJSONString();
    }
	
    @Override
    public @ResponseBody
    String Register(@NecessaryPara String phoneNumber, @NecessaryPara String password, @NecessaryPara String academy, @NecessaryPara String verification) throws LogicException {
        return userService.register(phoneNumber, password, academy, verification).toJSONString();
    }

    @Override
    public @ResponseBody
    String verificationCode(@NecessaryPara String phoneNumber) throws LogicException {
